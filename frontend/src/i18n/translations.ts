/**
 * UI translations for KeyStone. Keys are dot-namespaced; each maps to one string
...
export const TRANSLATIONS: Record<string, Entry> = {
  ...
  // ── Print report ─────────────────────────────────────────────────────────
  'print.header': {
    en: 'KeyStone · Zoning-plan compliance check',
    de: 'KeyStone · Bebauungsplan-Konformitätsprüfung',
  },
  ...
  'print.footer': {
    en: "Generated by KeyStone — AI Bebauungsplan reader. Demonstration output, not legally binding. Values reflect human-reviewed extraction and the planner's proposed building.",
    de: 'Erstellt von KeyStone — KI-Bebauungsplan-Reader. Demonstrationsausgabe, nicht rechtsverbindlich. Werte basieren auf der vom Menschen geprüften Extraktion und dem geplanten Gebäude.',
  },
